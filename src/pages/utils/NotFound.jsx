...
const NotFound = () => {
    return (
        <div className="bg-gray-200 w-full px-16 md:px-0 min-h-[calc(100vh-144px)] flex items-center justify-center">
            <div className="bg-white border border-gray-200 flex flex-col items-center justify-center px-4 md:px-8 lg:px-24 py-8 rounded-lg shadow-2xl">
                ...
                <Link to="/" className="flex items-center space-x-2 bg-burnt-red hover:brightness-95 text-gray-100 px-4 py-2 mt-6 rounded transition duration-150" title="Volver al Inicio">
